package com.tecraa.emanager.viewmodels;
...
//        realm.beginTransaction();
//        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME,"Business","Cash", "note here", new Date(), 5000, new Date().getTime()));
//        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE,"Investment","Bank", "note here", new Date(), -900, new Date().getTime()));
//        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME,"Rent","Cash", "note here", new Date(), 2000, new Date().getTime()));
//        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME,"Business","Card", "note here", new Date(), 500, new Date().getTime()));
//        realm.commitTransaction();
//    }
